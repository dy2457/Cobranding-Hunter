      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
        {items.length === 0 && (
           <div className="col-span-full py-12 rounded-[32px] border-2 border-dashed border-slate-200 bg-slate-50/50 flex flex-col items-center justify-center text-slate-400">
              <p className="font-bold text-sm">暂无内容</p>
           </div>
        )}
        ...
        {items.map(notebook => (
          ...
          >
             ...
             <div className="relative z-10">
                <h3 className="text-xl font-bold text-slate-900 leading-tight mb-3 line-clamp-2 group-hover:text-[#b5004a] transition-colors">
                  {notebook.name}
                </h3>
  ...
  return (
    <div className="max-w-5xl mx-auto pt-32 pb-20 px-6 animate-fade-in-up">
      <div className="flex items-center justify-between mb-12">
        <div>
          <h2 className="text-5xl font-bold text-slate-900 tracking-tight">灵感库</h2>
        </div>
      ...
      <Section 
        ...
        items={caseNotebooks} 
        icon="⚡️" 
        gradient="from-[#b5004a] to-cyan-300"
      />
